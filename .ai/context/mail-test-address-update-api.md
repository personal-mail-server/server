...
- Source of truth remains `doc/api/v1/mails/update/backend.md`.
...
## sync_note
- If update API contract, duplicate policy, or non-owner visibility rule changes, re-review this file with `doc/api/v1/mails/update/backend.md`.
